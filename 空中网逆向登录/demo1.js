var KZLoginHandler=
	{
	'id':'kongzhong-login-agent','loginServer':'http://sso.kongzhong.com','service':'','targetService':'','j_data':null,'f_call_back':null,'timestamp':0,'completed':false,'renew':false,'init':function()
		{
		this.j_data=null;
	...
	,'exec_login':function(param)
		...
		jQuery.ajax(
			{
			async:false,url:url,type:'post',dataType:'jsonp',jsonp:'j',data:param,jsonpCallback:"j",timeout:5000,success:function(json)
				{
			}
			,error:function(xhr)
				{
